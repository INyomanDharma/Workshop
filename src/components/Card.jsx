...
const Card = () => {
  return (
    <div className="flex justify-center mt-10 mb-5 gap-5">
      {image.map((data) => {
        return (
          <div key={data.id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 w-52">
            <a href="#">
              <img className="rounded-t-lg w-full mx-auto" src={data.src} alt={data.name} />
            </a>
            <div className="p-5">
              <a href="#">
